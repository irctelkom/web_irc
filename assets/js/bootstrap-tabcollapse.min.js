! function (a) {
    ...
    t.DEFAULTS = {
        ...
        tabsClass: "hidden-xs",
        accordionTemplate: function (a, t, e, s) {
            return '<div class="panel panel-default">   <div class="panel-heading">      <h4 class="panel-title">      </h4>   </div>   <div id="' + t + '" class="panel-collapse collapse ' + (s ? "in" : "") + '">       <div class="panel-body js-tabcollapse-panel-body">       </div>   </div></div>'
        }
        ...
        e.each(function () {
            var e = a(this),
                ...
                i = t._panelHeadingToTabHeading(e);
        ...
        if (s.each(function () {
                var t = a(this),
                    e = t.data("bs.tabcollapse.tabpane");
                e.append(t.children("*").detach())
            }), this.$accordion.html(""), this.options.updateLinks) {
            var i = a(this.options.tabContentSelector) || this.$tabs.siblings(".tab-content");
        ...
        if (t.each(function () {
                var t = a(this),
                    s = t.parent();
                t.data("bs.tabcollapse.parentLi", s), e.$accordion.append(e._createAccordionGroup(e.$accordion.attr("id"), t.detach()))
    ...
    }, t.prototype._panelHeadingToTabHeading = function (a) {
        var t = a.attr("href").replace(/-collapse$/g, "");
        return a.attr({
            "data-toggle": "tab",
            href: t,
            "data-parent": ""
        }), a
    }, t.prototype._tabHeadingToPanelHeading = function (a, t, e, s) {
        return a.addClass("js-tabcollapse-panel-heading " + (s ? "" : "collapsed")), a.attr({
            "data-toggle": "collapse",
            "data-parent": "#" + e,
            href: "#" + t
        }), a
    }, t.prototype._checkStateOnResize = function () {
        var t = this;
        ...
        this.$accordion = a('<div class="panel-group ' + this.options.accordionClass + '" id="' + this.$tabs.attr("id") + '-accordion"></div>'), this.$tabs.after(this.$accordion), this.$tabs.addClass(this.options.tabsClass);
        var t = a(this.options.tabContentSelector) || this.$tabs.siblings(".tab-content");
        t.addClass(this.options.tabsClass)
    }, t.prototype._createAccordionGroup = function (t, e) {
        var s = e.attr("data-target"),
            i = e.data("bs.tabcollapse.parentLi").is(".active");
        s || (s = e.attr("href"), s = s && s.replace(/.*(?=#[^\s]*$)/, ""));
        var o = a(s),
            n = o.attr("id") + "-collapse",
            c = a(this.options.accordionTemplate(e, n, t, i));
        return c.find(".panel-heading > .panel-title").append(this._tabHeadingToPanelHeading(e, n, t, i)), c.find(".panel-body").append(o.children("*").detach()).data("bs.tabcollapse.tabpane", o), c
    }, a.fn.tabCollapse = function (e) {
        return this.each(function () {
            var s = a(this),
                i = s.data("bs.tabcollapse"),
                o = a.extend({}, t.DEFAULTS, s.data(), "object" == typeof e && e);
            i || s.data("bs.tabcollapse", new t(this, o))
        })
    }, a.fn.tabCollapse.Constructor = t
}(window.jQuery);